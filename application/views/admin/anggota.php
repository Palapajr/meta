        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" onclick="add()"><i class="fas fa-plus"></i> Tambah</button>
            </div>
            <div class="card-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer bg-whitesmoke br">
        ...
        <button type="button" class="btn btn-success" id="btnSave" onclick="save()">Save changes</button>
      </div>
    </div>
  </div>
</div>
</div>
<!-- end Add Anggota Modal -->
